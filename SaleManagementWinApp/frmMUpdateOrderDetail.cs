...
{
    public partial class frmMUpdateOrderDetail : Form
    {
        IFlowerBouquetRepository repository = new FlowerBouquetRepository();
        private bool isInitializing = true;
        private frmManageOrderDetail _parentForm;
        private OrderDetailDTO orderDetailDTO;
        public frmMUpdateOrderDetail(frmManageOrderDetail parentForm, OrderDetailDTO orderDetailDTO)
        {
            InitializeComponent();
        ...
        public void LoadProductList()
        {
            try
            {
                ...
                if (cboProId.SelectedIndex != -1)
                {
                    ...
                    txtUnitsInStock.Text = (repository.GetProductDTOs().SingleOrDefault(p => p.FlowerBouquetId == proId).UnitsInStock + orderDetailDTO.Quantity).ToString();
        ...
        private void frmMUpdateOrderDetail_Load(object sender, EventArgs e)
        {
            LoadProductList();
